...
const EDIT_NOTI_FORM = (data: any) => {
    ...
    const [formDataPost, setFormDataPost] = useState<noti_model_post>({
        title: data.data.title || "", content: data.data.content || "", file: data.data.file || null,
    });
            ...
            <Stack direction={['column', 'row']}>
                <form>
                    ...
                    <Stack spacing={"20px"} fontFamily={"Oswald"} minW={500}>
                        <Heading my={50} textAlign="center" >Edit Notifications</Heading>

                        <HStack spacing={14} mb={5}>

                            <FormControl isRequired>
                                <FormLabel>Title</FormLabel>
                                <Input type={"text"} onChange={handleInputChange} placeholder={"Title"} defaultValue={data.data.title} name="title"></Input>
                            </FormControl>
                        ...
                        <HStack>
                            <FormControl isRequired>
                                ...
                                <Input type={"text"} onChange={handleInputChange} placeholder={"Content"} defaultValue={data.data.content} name="content"></Input>
                            </FormControl>
                        </HStack>
                        ...
                        <Button w={"full"} fontSize={"large"} onClick={handleSubmit}>Update</Button>
...
export default memo(EDIT_NOTI_FORM);