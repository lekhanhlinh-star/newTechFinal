...
const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Information', icon: CgProfile, link: "/students/info" },
    // { name: 'Manage Project', icon: CgProfile, link: "/students/managepj" },
    { name: 'Project', icon: FaFacebookMessenger, link: "/students/project" },
]
